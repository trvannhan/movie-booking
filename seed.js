...
async function seedData() {
  try {
    ...
    const movieSeeds = [
      {
        title: 'Dune: Phan Hai',
        description: 'Paul Atreides tro lai va buoc vao cuoc chien giua van menh, tinh yeu va quyen luc.',
      ...
      },
      {
        ...
        description: 'Hai quai vat khong lo doi dau trong tran chien quyet dinh so phan Trai Dat.',
        director: 'Adam Wingard',
        cast: ['Rebecca Hall', 'Brian Tyree Henry'],
        genre: ['Hanh dong', 'Phieu luu'],
        duration: 115,
        trailerUrl: 'https://www.youtube.com/watch?v=qqrpMRDuPfc',
        image: '/posters/godzilla-x-kong.jpg',
        status: 'now_showing',
        basePrice: 80000,
      ...
      {
        title: 'Lat Mat 8',
        description: 'Mot gia dinh bi cuon vao loat bien co khien moi dieu che giau deu bi phoi bay.',
        director: 'Ly Hai',
        cast: ['Quoc Cuong', 'Thanh Thuc', 'Le Hai'],
        genre: ['Tam ly', 'Hanh dong'],
        duration: 128,
        trailerUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
        image: '/posters/lat-mat-8.jpg',
        status: 'now_showing',
        basePrice: 75000,
      ...
      },
      {
        ...
        description: 'Po tro lai voi hanh trinh tim nguoi ke nhiem va doi dau ke thu moi.',
        director: 'Mike Mitchell',
        cast: ['Jack Black', 'Awkwafina'],
        genre: ['Hoat hinh', 'Gia dinh'],
        duration: 94,
        trailerUrl: 'https://www.youtube.com/watch?v=_inKs4eeHiI',
        image: '/posters/kung-fu-panda-4.jpg',
        status: 'now_showing',
        basePrice: 70000,
      ...
      {
        title: 'Civil War',
        description: 'Mot nhom nha bao di xuyen nuoc My trong boi canh xa hoi tan vo.',
      ...
      {
        title: 'Inside Out 2',
        description: 'Riley buoc vao tuoi teen va the gioi cam xuc lai them mot lan day song gio.',
      ...
      },
      {
        ...
        description: 'Cap doi ba dao nhat vu tru Marvel chinh thuc hop tac trong mot phien ban day dien.',
        director: 'Shawn Levy',
        cast: ['Ryan Reynolds', 'Hugh Jackman'],
        genre: ['Hanh dong', 'Hai huoc'],
        duration: 127,
        trailerUrl: 'https://www.youtube.com/watch?v=73_1biulkYk',
        image: '/posters/deadpool-&-wolverine.jpg',
        status: 'coming_soon',
        basePrice: 90000,
      ...
      {
        title: 'Avatar 3',
        description: 'Pandora mo rong voi mot bo toc moi va cuoc xung dot lon hon bao gio het.',
        director: 'James Cameron',
        cast: ['Sam Worthington', 'Zoe Saldana'],
        genre: ['Sci-Fi', 'Phieu luu'],
        duration: 192,
        trailerUrl: 'https://www.youtube.com/watch?v=nb_fFfxNHaA',
        image: '/posters/avatar-3.jpg',
        status: 'coming_soon',
        basePrice: 95000,
        releaseOffsetDays: 35
      },
      {
        ...
        description: 'Bo tu sieu anh hung quay tro lai voi ban tai khoi dong duoc mong cho.',
        director: 'Matt Shakman',
        cast: ['Pedro Pascal', 'Vanessa Kirby'],
        genre: ['Sci-Fi', 'Hanh dong'],
        duration: 134,
        trailerUrl: 'https://www.youtube.com/watch?v=pAsmrKyMqaA',
        image: '/posters/the-fantastic-four.jpg',
        status: 'coming_soon',
        basePrice: 88000,
    ...
    const nowShowingMovies = createdMovies.filter(movie => movie.status === 'now_showing');
    const showtimeTemplates = [
      { cinemaId: cinema1._id, roomId: room1._id, hour: 13, minute: 15, multiplier: 1.0 },
      { cinemaId: cinema1._id, roomId: room2._id, hour: 18, minute: 30, multiplier: 1.2 },
      { cinemaId: cinema2._id, roomId: room3._id, hour: 20, minute: 0, multiplier: 1.1 },
      { cinemaId: cinema3._id, roomId: room4._id, hour: 16, minute: 45, multiplier: 1.0 }
    ];
